          ...
          <div ref={userMenuRef} className="relative">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-56 clay rounded-2xl shadow-elevation-4 overflow-hidden animate-scale-in z-50">
                ...
                {/* Menu items */}
                <div className="p-2">
                  <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800/60 transition-all text-left">
